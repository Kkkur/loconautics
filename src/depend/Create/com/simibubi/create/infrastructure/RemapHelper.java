...
public class RemapHelper {
    ...
    static {
        ...
        reMap.put("copper_block", RegisteredObjectsHelper.getKeyOrThrow((Block)Blocks.COPPER_BLOCK));
        reMap.put("copper_ore", RegisteredObjectsHelper.getKeyOrThrow((Block)Blocks.COPPER_ORE));
        ...
        reMap.put("gabbro", ResourceLocation.withDefaultNamespace((String)"dripstone_block"));
        reMap.put("dolomite", ResourceLocation.withDefaultNamespace((String)"calcite"));
        reMap.put("weathered_limestone", ResourceLocation.withDefaultNamespace((String)"tuff"));
        reMap.put("gabbro_cobblestone", ResourceLocation.withDefaultNamespace((String)"dripstone_block"));
        reMap.put("andesite_cobblestone", ResourceLocation.withDefaultNamespace((String)"andesite"));
        reMap.put("diorite_cobblestone", ResourceLocation.withDefaultNamespace((String)"diorite"));
        reMap.put("granite_cobblestone", ResourceLocation.withDefaultNamespace((String)"granite"));
        reMap.put("dark_scoria", Create.asResource("scorchia"));
        RemapHelper.remapPaletteBlock("andesite", "andesite", true);
        RemapHelper.remapPaletteBlock("diorite", "diorite", true);
        RemapHelper.remapPaletteBlock("granite", "granite", true);
        RemapHelper.remapPaletteBlock("limestone", "limestone", false);
        RemapHelper.remapPaletteBlock("gabbro", "dripstone", false);
        RemapHelper.remapPaletteBlock("scoria", "scoria", false);
        RemapHelper.remapPaletteBlock("dark_scoria", "scorchia", false);
        RemapHelper.remapPaletteBlock("dolomite", "calcite", false);
        RemapHelper.remapPaletteBlock("weathered_limestone", "tuff", false);
        ...
        for (String string : new String[]{"iron", "gold", "copper", "zinc"}) {
            reMap.put("crushed_" + string + "_ore", Create.asResource("crushed_raw_" + string));
        }
        for (CommonMetal commonMetal : CommonMetal.values()) {
            reMap.put("crushed_" + commonMetal.name + "_ore", Create.asResource("crushed_raw_" + commonMetal.name));
        }
    }
}
