...
public class ArmScenes {
    public static void setup(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay().showControls(util.vector().blockSurface(outputDepot, Direction.NORTH), Pointing.RIGHT, 20).rightClick().withItem(armItem);
        scene.idle(7);
        Object second = new Object();
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.INPUT, second, depotBounds.move(0.0, 2.0, 1.0), 100);
        scene.idle(25);
        scene.overlay().showControls(util.vector().blockSurface(outputDepot, Direction.NORTH), Pointing.RIGHT, 30).rightClick().withItem(armItem);
        scene.idle(7);
        ...
        copper = new ItemStack((ItemLike)Items.COPPER_BLOCK);
        scene.world().createItemOnBeltLike(inputDepot, Direction.SOUTH, copper);
        scene.idle(20);
        ...
        scene.world().instructArm(armPos, ArmBlockEntity.Phase.SEARCH_INPUTS, ItemStack.EMPTY, -1);
        scene.idle(5);
        scene.overlay().showControls(util.vector().blockSurface(util.grid().at(0, 2, 3), Direction.WEST), Pointing.LEFT, 30).withItem(sword);
    }
    ...
    public static void filtering(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        ItemStack sand = new ItemStack((ItemLike)Items.SAND, 64);
        ItemStack sulphur = new ItemStack((ItemLike)Items.GUNPOWDER, 64);
        ...
        for (int y = 0; y < 3; ++y) {
            for (int x = 0; x < 3; ++x) {
                ...
                scene.overlay().showControls(filterSlot.add((double)(2 - x), (double)(-y), 0.0), Pointing.LEFT, 5).rightClick().withItem(item);
                scene.idle(7);
        ...
        scene.idle(20);
        scene.rotateCameraY(120.0f);
        scene.world().setCraftingResult(util.grid().at(3, 1, 1), new ItemStack((ItemLike)Blocks.TNT));
        for (i = 0; i < 5; ++i) {
            int index = i * 2;
    ...
    public static void modes(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.INPUT, (Object)depotBox, depotBox.move(1.0, 1.0, 4.0), 60);
        ...
        scene.idle(40);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.OUTPUT, (Object)depotBox, beltBox.move(2.0, 1.0, 2.0), 40);
        ...
        scene.idle(50);
        ItemStack item = new ItemStack((ItemLike)Items.SNOWBALL);
        ...
        for (int i = 0; i < 20; ++i) {
            ...
            if (i == 13) {
                ...
                ElementLink blockage2 = scene.world().showIndependentSection(util.select().position(4, 1, 0), Direction.UP);
    ...
    public static void redstone(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        ItemStack item = new ItemStack((ItemLike)Items.REDSTONE_ORE);
