...
public class FrogAndConveyorScenes {
    public static void conveyor(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        FrogAndConveyorScenes.connection(builder, conv1, conv2, false);
        FrogAndConveyorScenes.connection(builder, conv1, conv3, false);
        FrogAndConveyorScenes.connection(builder, conv1, conv4, false);
        ...
        scene.idle(20);
        ItemStack chainItem = new ItemStack((ItemLike)Items.CHAIN);
        ...
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, (Object)conv1, bb1, 10);
        scene.idle(1);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, (Object)conv1, bb1.inflate(1.0, 0.5, 1.0), 117);
        scene.idle(16);
        ...
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, (Object)conv2, bb2, 10);
        scene.idle(1);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, (Object)conv2, bb2.inflate(1.0, 0.5, 1.0), 100);
        scene.idle(10);
        FrogAndConveyorScenes.connection(builder, conv1, conv2, true);
        scene.world().setKineticSpeed(conv2S, -32.0f);
        scene.overlay().showText(80).text("Right-click two conveyors with chains to connect them").attachKeyFrame().placeNearTarget().pointAt(util.vector().topOf(conv1.offset(-1, 0, -1)));
        scene.idle(90);
        ...
        scene.idle(12);
        FrogAndConveyorScenes.connection(builder, conv1, conv3, true);
        scene.idle(3);
        FrogAndConveyorScenes.connection(builder, conv1, conv4, true);
        scene.idle(20);
        scene.overlay().showText(70).text("Chain conveyors relay rotational power between each other..").attachKeyFrame().placeNearTarget().pointAt(util.vector().topOf(conv3.offset(-1, 0, -1)));
        scene.idle(60);
        ...
        scene.idle(10);
        scene.overlay().showText(60).text("..and connect to shafts above or below them").attachKeyFrame().placeNearTarget().pointAt(util.vector().centerOf(util.grid().at(1, 2, 7)));
        scene.idle(60);
        scene.world().hideSection(cogsBelow, Direction.SOUTH);
        scene.idle(15);
        ElementLink poleE2 = scene.world().showIndependentSection(pole, Direction.EAST);
        scene.world().moveSection(poleE2, util.vector().of(0.0, 0.0, 1.0), 0);
        scene.idle(10);
        ...
        Vec3 parrotStart = util.vector().centerOf(conv2).add(0.0, -1.45, 1.0);
        ...
        scene.addInstruction(arg_0 -> FrogAndConveyorScenes.lambda$conveyor$0(element, (ElementLink)parrot, arg_0));
        scene.special().movePointOfInterest(util.grid().at(0, 3, 2));
        scene.idle(20);
        scene.special().moveParrot((ElementLink)parrot, util.vector().of(-1.0, 0.0, -1.0), 14);
        scene.idle(14);
        scene.special().movePointOfInterest(util.grid().at(7, 3, 0));
        scene.special().moveParrot((ElementLink)parrot, util.vector().of(5.75, 0.0, -5.75), 90);
        scene.idle(65);
        scene.overlay().showText(60).text("At a junction, face towards a chain to follow it").attachKeyFrame().placeNearTarget().pointAt(util.vector().topOf(conv1));
        scene.idle(25);
        scene.special().movePointOfInterest(util.grid().at(9, 3, 1));
        scene.special().moveParrot((ElementLink)parrot, util.vector().of(1.0, 0.0, -1.0), 14);
        scene.idle(14);
        scene.special().movePointOfInterest(util.grid().at(9, 3, 3));
        scene.special().moveParrot((ElementLink)parrot, util.vector().of(0.5, 0.0, 0.0), 6);
        scene.idle(6);
        scene.special().movePointOfInterest(util.grid().at(8, 3, 10));
        scene.special().moveParrot((ElementLink)parrot, util.vector().of(0.5, 0.0, 0.5), 14);
        scene.idle(14);
        scene.special().moveParrot((ElementLink)parrot, util.vector().of(0.0, 0.0, 7.0), 78);
        scene.idle(78);
        scene.special().hideElement((ElementLink)parrot, Direction.SOUTH);
    }
    ...
    public static void frogPort(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        Selection toBelt = util.select().fromTo(1, 1, 9, 0, 1, 9).add(util.select().fromTo(0, 1, 8, 0, 1, 6)).add(util.select().fromTo(1, 1, 5, 0, 1, 5));
        ...
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.WHITE, (Object)conv1, bb1, 10);
        scene.idle(1);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.WHITE, (Object)conv1, bb1.inflate(0.025, 0.025, 0.025), 50);
        scene.idle(26);
        scene.overlay().showText(80).text("Right-click a Chain Conveyor and place the Frogport nearby").attachKeyFrame().placeNearTarget().pointAt(fromTarget);
        scene.idle(40);
        ElementLink fromFrogE = scene.world().showIndependentSection(fromFrogS, Direction.DOWN);
        scene.world().moveSection(fromFrogE, util.vector().of(0.0, -1.0, 0.0), 0);
        scene.idle(15);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, (Object)conv1, bb1.inflate(0.025, 0.025, 0.025), 50);
        AABB bb2 = new AABB(fromFrog.below()).contract(0.0, 0.75, 0.0);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, (Object)conv2, bb2, 50);
        scene.idle(10);
        ...
        scene.idle(7);
        scene.overlay().showOutlineWithText(util.select().position(fromFrog.below()), 70).attachKeyFrame().colored(PonderPalette.BLUE).text("Assign it an address in the inventory UI").pointAt(util.vector().topOf(fromFrog.below())).placeNearTarget();
        scene.idle(80);
        scene.world().moveSection(fromFrogE, util.vector().of(0.0, 1.0, 0.0), 10);
        scene.idle(10);
        ElementLink casingE = scene.world().showIndependentSection(casing, Direction.NORTH);
        scene.world().moveSection(casingE, util.vector().of(0.0, 0.0, -2.0), 0);
        scene.idle(5);
        ...
        scene.idle(5);
        scene.world().multiplyKineticSpeed(util.select().fromTo(9, 0, 1, 5, 1, 0), 0.03125f);
        scene.overlay().showText(60).attachKeyFrame().text("If the address of an inserted package does not match it..").pointAt(util.vector().topOf(5, 0, 3)).placeNearTarget();
        scene.idle(70);
        scene.overlay().showText(40).colored(PonderPalette.BLUE).text("Albert").pointAt(util.vector().topOf(fromFrog)).placeNearTarget();
        scene.idle(5);
        scene.overlay().showText(40).colored(PonderPalette.OUTPUT).text("\u2192 Peter").pointAt(util.vector().centerOf(util.grid().at(5, 2, 0))).placeNearTarget();
        scene.idle(50);
        ...
        scene.idle(15);
        scene.overlay().showText(60).text("..the Frogport will place the package on the conveyor").pointAt(fromTarget.add(0.0, 0.0, 1.5)).placeNearTarget();
        scene.idle(95);
        scene.overlay().showText(60).attachKeyFrame().colored(PonderPalette.RED).text("Packages spin in place if they have no valid destination").pointAt(util.vector().of(6.5, 4.25, 7.5)).placeNearTarget();
        scene.idle(60);
        ...
        AABB bb4 = new AABB(toFrog).contract(0.0, 0.75, 0.0);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, (Object)conv3, bb3.inflate(0.025, 0.025, 0.025), 80);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, (Object)lever, bb4, 80);
        scene.overlay().showLine(PonderPalette.GREEN, util.vector().topOf(toFrog), toTarget, 80);
        scene.idle(10);
        scene.overlay().showText(70).text("More Frogports can be added anywhere on the chain network").attachKeyFrame().placeNearTarget().pointAt(toTarget);
        scene.idle(75);
        ...
        scene.idle(50);
        scene.overlay().showText(70).attachKeyFrame().text("Packages find their path to a matching frog on the chain network").pointAt(util.vector().topOf(toFrog)).placeNearTarget();
        scene.idle(40);
        ...
        scene.world().setKineticSpeed(util.select().fromTo(1, 1, 5, 0, 1, 5), 0.0f);
        scene.overlay().showText(50).colored(PonderPalette.BLUE).text("Peter").pointAt(util.vector().topOf(toFrog)).placeNearTarget();
        scene.idle(5);
        scene.overlay().showText(55).colored(PonderPalette.OUTPUT).text("\u2192 Peter").pointAt(util.vector().centerOf(util.grid().at(0, 2, 5))).placeNearTarget();
        scene.idle(60);
        ...
        scene.idle(15);
        ElementLink fromBarrelE = scene.world().showIndependentSection(fromBarrel, Direction.WEST);
        scene.world().moveSection(fromBarrelE, util.vector().of(0.0, 0.0, -1.0), 0);
        ElementLink toBarrelE = scene.world().showIndependentSection(toBarrel, Direction.WEST);
        scene.world().moveSection(toBarrelE, util.vector().of(-1.0, 0.0, 0.0), 0);
        scene.idle(20);
        scene.overlay().showOutlineWithText(util.select().position(fromFrog.below()).add(fromFrogS), 70).attachKeyFrame().colored(PonderPalette.BLUE).text("Frogports can directly interface with inventories below them").pointAt(util.vector().topOf(fromFrog.below())).placeNearTarget();
        scene.idle(70);
        ...
        ElementLink toPackagerE = scene.world().showIndependentSection(toPackager, Direction.EAST);
        scene.world().moveSection(toPackagerE, util.vector().of(0.0, 0.0, 1.0), 0);
        ElementLink leverE = scene.world().showIndependentSection(util.select().position(lever), Direction.DOWN);
        scene.world().moveSection(leverE, util.vector().of(-1.0, 0.0, 0.0), 0);
        scene.idle(15);
        scene.overlay().showText(90).attachKeyFrame().text("This also works with packagers. Items can be packed and shipped directly").pointAt(util.vector().blockSurface(fromFrog.below(), Direction.WEST)).placeNearTarget();
        scene.idle(100);
        ...
        scene.idle(20);
        scene.overlay().showOutlineWithText(util.select().position(fromFrog.below()).add(util.select().position(fromFrog.below().west())), 70).colored(PonderPalette.OUTPUT).text("Addresses packages to 'Peter'").pointAt(util.vector().blockSurface(fromFrog.below().west(), Direction.NORTH)).placeNearTarget();
        scene.idle(80);
        scene.overlay().showControls(util.vector().blockSurface(util.grid().at(6, 1, 2), Direction.UP).add(0.5, 0.0, 0.0), Pointing.DOWN, 40).withItem(new ItemStack((ItemLike)Items.DIAMOND));
        scene.idle(25);
        scene.addKeyframe();
        ...
        scene.idle(30);
        scene.world().modifyBlockEntity(util.grid().at(5, 1, 2), PackagerBlockEntity.class, be -> {
        ...
        scene.idle(20);
        scene.overlay().showControls(util.vector().blockSurface(util.grid().at(0, 1, 5), Direction.UP).add(0.5, 0.0, 0.0), Pointing.DOWN, 40).withItem(new ItemStack((ItemLike)Items.DIAMOND));
        scene.idle(60);
        scene.overlay().showControls(util.vector().centerOf(util.grid().at(2, 2, 5)), Pointing.RIGHT, 40).rightClick().withItem(AllBlocks.CLIPBOARD.asStack());
        scene.idle(10);
        scene.overlay().showText(90).attachKeyFrame().text("Right-click Frogports with a clipboard to collect their address").pointAt(util.vector().blockSurface(toFrog, Direction.WEST)).placeNearTarget();
        scene.idle(70);
        scene.world().showSection(logistics, Direction.DOWN);
        scene.idle(30);
        scene.overlay().showText(120).text("Clipboards with collected names can help auto-complete address inputs in other UIs").pointAt(util.vector().topOf(util.grid().at(2, 1, 2))).placeNearTarget();
        scene.idle(70);
    }

    public static void boxTransfer(BlockPos to, BlockPos from, ChainConveyorBlockEntity be) {
        Iterator<ChainConveyorPackage> iterator = be.getLoopingPackages().iterator();
        while (iterator.hasNext()) {
            ChainConveyorPackage chainConveyorPackage = iterator.next();
            chainConveyorPackage.chainPosition = 0.0f;
            be.addTravellingPackage(chainConveyorPackage, to.subtract((Vec3i)from));
            iterator.remove();
        }
    }

    private static /* synthetic */ void lambda$conveyor$0(ChainConveyorParrotElement element, ElementLink parrot, PonderScene s) {
