...
public class RollerScenes {
    public static void clearAndPave(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        for (int i4 = 8; i4 >= 0; --i4) {
            scene.world().showSection(util.select().position(i4, 1, 4), Direction.DOWN);
            scene.idle(1);
        }
        ...
        ElementLink trainLink = scene.world().showIndependentSection(train, Direction.DOWN);
        scene.idle(5);
        ...
        ItemStack paveItem = new ItemStack((ItemLike)paveMaterial);
        ...
        scene.idle(10);
        ElementLink gantryLink = scene.world().showIndependentSection(gantryCar, Direction.UP);
        ...
        scene.idle(5);
        ElementLink gantryLink3 = scene.world().showIndependentSection(chest, Direction.SOUTH);
        scene.world().moveSection(gantryLink3, util.vector().of(0.0, 0.0, -2.0), 0);
        scene.idle(15);
        paveMaterial = Blocks.GRASS_BLOCK;
        paveItem = new ItemStack((ItemLike)paveMaterial);
        scene.overlay().showControls(filterSlot, Pointing.DOWN, 40).withItem(paveItem);
        scene.idle(7);
        scene.world().setFilterData(rollers, RollerBlockEntity.class, paveItem);
        scene.idle(20);
    ...
    public static void fill(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        for (int i3 = 8; i3 >= 0; --i3) {
            scene.world().showSection(util.select().fromTo(i3, 4, 3, i3, 5, 5), Direction.DOWN);
            scene.idle(1);
        }
        scene.idle(5);
        ...
        ItemStack paveItem = new ItemStack((ItemLike)paveMaterial);
        scene.overlay().showControls(filterSlot.add(0.0, 0.0, -0.375), Pointing.UP, 35).withItem(paveItem);
        scene.idle(7);
        scene.world().setFilterData(rollers, RollerBlockEntity.class, paveItem);
        scene.idle(10);
        scene.world().cycleBlockProperty(stationPos, (Property)StationBlock.ASSEMBLING);
