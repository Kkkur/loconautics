...
public class TrackObserverScenes {
    public static void observe(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay().showControls(target, Pointing.DOWN, 40).rightClick().withItem(AllBlocks.TRACK_OBSERVER.asStack());
        scene.idle(6);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, (Object)bb, bb, 1);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, (Object)bb, bb.inflate((double)0.45f, 0.0625, (double)0.45f), 60);
        scene.idle(10);
        ...
        scene.idle(15);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, (Object)bb, new AABB(util.grid().at(5, 1, 4)), 20);
        scene.idle(25);
        ...
        scene.idle(30);
        ElementLink trainInstance1 = scene.world().showIndependentSection(train1, Direction.WEST);
        ...
        scene.idle(10);
        ElementLink trainInstance2 = scene.world().showIndependentSection(train2, Direction.WEST);
