...
public class PostboxScenes {
    public static void postbox(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        ElementLink base = scene.world().showIndependentSection(util.select().fromTo(0, 0, 1, 8, 0, 9), Direction.UP);
        scene.idle(10);
        ElementLink tracksL = scene.world().showIndependentSection(util.select().position(8, 1, 5), Direction.DOWN);
        scene.idle(1);
        for (int i = 7; i >= 0; --i) {
        ...
        ItemStack postboxItem = AllBlocks.PACKAGE_POSTBOXES.get(DyeColor.WHITE).asStack();
        ...
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.WHITE, (Object)box, bb1, 10);
        scene.idle(1);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.WHITE, (Object)box, bb1.inflate(0.025, 0.025, 0.025), 50);
        scene.idle(26);
        ...
        scene.idle(40);
        ElementLink postboxE = scene.world().showIndependentSection(boxS, Direction.DOWN);
        scene.world().moveSection(postboxE, util.vector().of(0.0, -1.0, 0.0), 0);
        scene.idle(15);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, (Object)box, bb1.inflate(0.025, 0.025, 0.025), 50);
        AABB bb2 = new AABB(box.below()).deflate(0.125, 0.0, 0.0).contract(0.0, 0.125, 0.0);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, (Object)box2, bb2, 50);
        scene.idle(10);
        ...
        scene.idle(7);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.BLUE, (Object)funnel, bb2, 70);
        scene.overlay().showText(70).attachKeyFrame().colored(PonderPalette.BLUE).text("Assign it an address in the inventory UI").pointAt(util.vector().topOf(box.below())).placeNearTarget();
        scene.idle(80);
        ...
        scene.idle(70);
        scene.overlay().showText(40).colored(PonderPalette.BLUE).text("Warehouse").pointAt(util.vector().blockSurface(box, Direction.NORTH).add(-0.5, 0.0, 0.0)).placeNearTarget();
        scene.idle(5);
        ...
        scene.idle(15);
        ElementLink train1L = scene.world().showIndependentSection(train1, null);
        ...
        scene.idle(14);
        ElementLink train2L = scene.world().showIndependentSection(train2, null);
        ...
        PostboxScenes.animatePostbox(scene, box, true);
        scene.idle(60);
        scene.overlay().showText(100).text("Packages that arrived by train can be extracted from the Postbox").attachKeyFrame().pointAt(util.vector().blockSurface(box, Direction.NORTH)).placeNearTarget();
        scene.idle(60);
        ...
        scene.overlay().showText(40).colored(PonderPalette.BLUE).text("Warehouse").pointAt(util.vector().blockSurface(box, Direction.NORTH).add(-0.5, 0.0, 0.0)).placeNearTarget();
        scene.idle(5);
        scene.overlay().showText(40).colored(PonderPalette.OUTPUT).text("\u2192 Warehouse").pointAt(util.vector().centerOf(3, 2, 2).add(0.0, -0.25, 0.0)).placeNearTarget();
        scene.idle(50);
        ElementLink tracksL2 = scene.world().showIndependentSection(tracks, Direction.EAST);
        ...
        scene.idle(5);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.BLUE, (Object)train1L, new AABB(util.grid().at(1, 3, 4)).inflate(1.0, 0.75, 0.5), 280);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.BLUE, (Object)train2L, new AABB(util.grid().at(5, 3, 4)).inflate(1.0, 0.75, 0.5), 280);
        scene.idle(19);
        ElementLink outpostL = scene.world().showIndependentSection(glass, Direction.UP);
        ...
        scene.idle(9);
        ElementLink stationL = scene.world().showIndependentSection(stationS.add(box2S), Direction.DOWN);
        ...
        scene.overlay().showText(90).text("Packages can still be delivered from or to their inventory").colored(PonderPalette.BLUE).placeNearTarget().pointAt(util.vector().blockSurface(util.grid().at(3, 1, 8), Direction.NORTH));
        scene.idle(80);
    }
