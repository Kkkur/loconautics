...
public class MechanicalDrillScenes {
    public static void breaker(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        ElementLink plankEntity = scene.world().createItemEntity(util.vector().centerOf(breakingPos), util.vector().of(0.0, (double)0.1f, 0.0), new ItemStack((ItemLike)Items.OAK_PLANKS));
        scene.idle(20);
        scene.idle(15);
        ...
        scene.world().createItemEntity(util.vector().centerOf(breakingPos), util.vector().of(0.0, (double)0.1f, 0.0), new ItemStack((ItemLike)Items.OAK_PLANKS));
        scene.idle(50);
    }
    ...
    public static void contraption(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.idle(5);
        ElementLink contraption = scene.world().showIndependentSection(util.select().fromTo(4, 2, 3, 4, 1, 2), Direction.DOWN);
        scene.idle(5);
        ...
        ItemStack item = new ItemStack((ItemLike)Items.OAK_PLANKS);
        ...
        scene.world().setKineticSpeed(drills, 0.0f);
        scene.idle(10);
        scene.overlay().showControls(util.vector().topOf(2, 3, 2), Pointing.DOWN, 60).withItem(new ItemStack((ItemLike)Blocks.OAK_PLANKS));
        scene.idle(20);
    }
}
