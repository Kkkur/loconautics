...
public class TrackScenes {
    public static void placement(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.showBasePlate();
        scene.idle(10);
        ElementLink bgTrack = scene.world().showIndependentSection(util.select().position(11, 4, 9), Direction.DOWN);
        ...
        scene.idle(50);
        ElementLink fgTrack = scene.world().showIndependentSection(util.select().position(3, 3, 5), Direction.DOWN);
        ...
        scene.overlay().showControls(startTrack, Pointing.DOWN, 40).rightClick().withItem(trackStack);
        scene.idle(6);
        AABB bb = new AABB(util.grid().at(3, 1, 5)).contract(0.0, 0.75, 0.0).inflate(0.0, 0.0, (double)0.85f);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, (Object)startTrack, bb, 32);
        scene.idle(45);
        scene.overlay().showControls(startTrack.add(9.0, 0.0, 0.0), Pointing.DOWN, 40).rightClick().withItem(trackStack);
        scene.idle(6);
        ...
        scene.idle(20);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, (Object)startTrack, bb.expandTowards(9.0, 0.0, 0.0), 30);
        ...
        bb = new AABB(util.grid().at(5, 1, 5)).contract(0.0, 0.75, 0.0).inflate(3.0, 0.0, 3.0).expandTowards((double)0.85f, 0.0, (double)0.85f);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, (Object)startTrack, bb, 32);
        scene.idle(20);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, (Object)startTrack, bb.move(4.0, 0.0, 4.0), 32);
        scene.idle(30);
        ...
        scene.idle(50);
        ElementLink longBend = scene.world().showIndependentSection(util.select().position(2, 2, 12), Direction.DOWN);
        ...
        scene.idle(25);
        ElementLink slopeStart = scene.world().showIndependentSection(util.select().fromTo(12, 6, 2, 12, 9, 12), Direction.DOWN);
        ...
        scene.idle(4);
        ItemStack smoothStone = new ItemStack((ItemLike)Blocks.SMOOTH_STONE);
        ...
        scene.idle(4);
        smoothStone = new ItemStack((ItemLike)Blocks.SMOOTH_STONE_SLAB);
    ...
    public static void portal(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.idle(40);
        ElementLink t1 = scene.world().showIndependentSection(util.select().fromTo(5, 2, 1, 3, 3, 2), Direction.DOWN);
        ElementLink t2 = scene.world().showIndependentSection(util.select().fromTo(5, 2, 3, 3, 3, 3), Direction.DOWN);
        ElementLink t3 = scene.world().showIndependentSection(util.select().fromTo(5, 2, 4, 3, 3, 5), Direction.DOWN);
        ...
        scene.addKeyframe();
        scene.idle(30);
        for (ElementLink e : List.of(t1, t2, t3)) {
        ...
        for (ElementLink e : List.of(t3, t2, t1)) {
            scene.idle(2);
        ...
        ElementLink nether = scene.world().showIndependentSection(util.select().layers(7, 1), Direction.UP);
        scene.world().moveSection(nether, util.vector().of(0.0, -7.0, 0.0), 0);
        scene.special().moveParrot(birb, util.vector().of(0.0, 0.0, (double)-0.1f), 1);
        scene.idle(25);
        ElementLink s1 = scene.world().showIndependentSection(util.select().fromTo(5, 2, 1, 3, 3, 5), null);
    ...
    public static void chunks(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.removeShadow();
        scene.setSceneOffsetY(-1.0f);
        scene.world().cycleBlockProperty(util.grid().at(5, 3, 4), (Property)BlazeBurnerBlock.HEAT_LEVEL);
        ElementLink stationElement = scene.world().showIndependentSection(util.select().fromTo(0, 0, 0, 8, 0, 8), Direction.UP);
        ElementLink stationTrackElement = scene.world().showIndependentSection(util.select().position(0, 2, 0), Direction.UP);
        ...
        scene.idle(10);
        ElementLink trackElement = scene.world().showIndependentSection(track, Direction.EAST);
        ...
        scene.idle(5);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.BLUE, (Object)trainElement, new AABB(util.grid().at(4, 2, 4)).inflate(1.0, 0.75, 0.5), 280);
        scene.idle(15);
        ...
        ElementLink dPlatformElement = scene.world().showIndependentSection(dPlatform, null);
