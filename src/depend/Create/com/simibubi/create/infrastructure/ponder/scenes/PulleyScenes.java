...
public class PulleyScenes {
    public static void movement(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        ElementLink plank = scene.world().showIndependentSection(util.select().position(2, 1, 2), Direction.UP);
        scene.idle(5);
        ...
        scene.idle(15);
        ElementLink chassis = scene.world().showIndependentSection(util.select().fromTo(2, 1, 1, 0, 2, 1), Direction.SOUTH);
        ...
        scene.overlay().showOutline(PonderPalette.GREEN, (Object)"glue", util.select().position(3, 1, 1).add(util.select().fromTo(1, 1, 2, 3, 1, 2)).add(util.select().position(1, 2, 2)), 40);
    ...
    public static void movementModes(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.idle(10);
        scene.world().showSection(util.select().position(pulleyPos), Direction.SOUTH);
        ElementLink glass = scene.world().showIndependentSection(util.select().position(pulleyPos.below()), Direction.UP);
        scene.idle(20);
        scene.world().toggleRedstonePower(redstoneStuff);
        scene.effects().indicateRedstone(leverPos);
        scene.world().modifyKineticSpeed(reversable, f -> Float.valueOf(-f.floatValue()));
    ...
    public static void attachment(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        ElementLink poles = scene.world().showIndependentSection(util.select().fromTo(4, 4, 2, 6, 4, 2), Direction.DOWN);
        scene.world().moveSection(poles, util.vector().of(0.0, -1.0, 0.0), 0);
        scene.idle(10);
        BlockPos pulleyPos = util.grid().at(3, 3, 2);
        ElementLink pulley = scene.world().showIndependentSection(util.select().position(pulleyPos), Direction.EAST);
        scene.idle(10);
    ...
    public static void multiRope(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        ElementLink planksLink = scene.world().showIndependentSection(contraption, Direction.DOWN);
        scene.idle(10);
