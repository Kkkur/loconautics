...
extends AbstractSimiContainerScreen<FactoryPanelSetItemMenu> {
    ...
    protected void renderBg(GuiGraphics pGuiGraphics, float pPartialTick, int pMouseX, int pMouseY) {
        ...
        pGuiGraphics.drawString(this.font, (Component)title, x + this.imageWidth / 2 - this.font.width((FormattedText)title) / 2 - 5, y + 4, 4013128, false);
        GuiGameElement.of((ItemStack)stack).scale(3.0).render(pGuiGraphics, x + 180, y + 48);
    }
