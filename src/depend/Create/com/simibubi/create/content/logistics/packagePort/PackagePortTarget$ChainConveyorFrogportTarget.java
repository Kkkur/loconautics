...
public static class PackagePortTarget.ChainConveyorFrogportTarget
extends PackagePortTarget {
    public static final MapCodec<PackagePortTarget.ChainConveyorFrogportTarget> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)BlockPos.CODEC.fieldOf("relative_pos").forGetter(i -> i.relativePos), (App)Codec.FLOAT.fieldOf("chain_pos").forGetter(i -> Float.valueOf(i.chainPos)), (App)BlockPos.CODEC.optionalFieldOf("connection").forGetter(i -> Optional.ofNullable(i.connection)), (App)Codec.BOOL.fieldOf("flipped").forGetter(i -> i.flipped)).apply((Applicative)instance, PackagePortTarget.ChainConveyorFrogportTarget::new));
    public static final StreamCodec<ByteBuf, PackagePortTarget.ChainConveyorFrogportTarget> STREAM_CODEC = StreamCodec.composite((StreamCodec)BlockPos.STREAM_CODEC, i -> i.relativePos, (StreamCodec)ByteBufCodecs.FLOAT, i -> Float.valueOf(i.chainPos), (StreamCodec)CatnipStreamCodecBuilders.nullable((StreamCodec)BlockPos.STREAM_CODEC), i -> i.connection, (StreamCodec)ByteBufCodecs.BOOL, i -> i.flipped, PackagePortTarget.ChainConveyorFrogportTarget::new);
    public float chainPos;
    @Nullable
    public BlockPos connection;
    public boolean flipped;

    public PackagePortTarget.ChainConveyorFrogportTarget(BlockPos relativePos, float chainPos, Optional<BlockPos> connection, boolean flipped) {
        this(relativePos, chainPos, (BlockPos)connection.orElse(null), flipped);
    }

    public PackagePortTarget.ChainConveyorFrogportTarget(BlockPos relativePos, float chainPos, @Nullable BlockPos connection, boolean flipped) {
        super(relativePos);
