...
public class EntityLauncher {
    ...
    public void applyMotion(Entity entity, Direction facing) {
        ...
        motionVec = VecHelper.rotate((Vec3)motionVec, (double)AngleHelper.horizontalAngle((Direction)facing), (Direction.Axis)Direction.Axis.Y);
    ...
    public Vec3 getGlobalPos(double t, Direction d, BlockPos launcher) {
        Vec3 start = new Vec3((double)((float)launcher.getX() + 0.5f), (double)((float)launcher.getY() + 0.5f), (double)((float)launcher.getZ() + 0.5f));
        float xt = this.x(t);
        float yt = this.y(t);
        double progress = Mth.clamp((double)(t / this.getTotalFlyingTicks()), (double)0.0, (double)1.0);
        ...
        return VecHelper.rotate((Vec3)vec, (double)(180.0f + AngleHelper.horizontalAngle((Direction)d)), (Direction.Axis)Direction.Axis.Y).add(start);
    }

    public Vec3 getGlobalVelocity(double t, Direction d, BlockPos launcher) {
        return VecHelper.rotate((Vec3)new Vec3(0.0, (double)this.dy(t), (double)this.dx(t)), (double)(180.0f + AngleHelper.horizontalAngle((Direction)d)), (Direction.Axis)Direction.Axis.Y);
    }
