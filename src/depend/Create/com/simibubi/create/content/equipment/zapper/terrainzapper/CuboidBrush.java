...
extends ShapedBrush {
    ...
    public void set(int param0, int param1, int param2) {
        ...
        if (updateShape) {
            ...
            this.positions = BlockPos.betweenClosedStream((BlockPos)zero.offset((param0 - 1) / -2, (param1 - 1) / -2, (param2 - 1) / -2), (BlockPos)zero.offset(param0 / 2, param1 / 2, param2 / 2)).map(BlockPos::new).collect(Collectors.toList());
        }
    }
