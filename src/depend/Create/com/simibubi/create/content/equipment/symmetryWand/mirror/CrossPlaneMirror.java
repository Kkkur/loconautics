...
extends SymmetryMirror {
    ...
    public void applyModelTransform(PoseStack ms) {
        ...
        ((PoseTransformStack)((PoseTransformStack)TransformStack.of((PoseStack)ms).center()).rotateYDegrees((Align)this.orientation == Align.Y ? 0.0f : 45.0f)).uncenter();
    }

    @Override
    public List<Component> getAlignToolTips() {
        return ImmutableList.of((Object)CreateLang.translateDirect("orientation.orthogonal", new Object[0]), (Object)CreateLang.translateDirect("orientation.diagonal", new Object[0]));
    }
