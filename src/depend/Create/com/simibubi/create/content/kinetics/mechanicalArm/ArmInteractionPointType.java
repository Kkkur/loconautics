...
public abstract class ArmInteractionPointType {
    ...
    public static final @UnmodifiableView List<ArmInteractionPointType> SORTED_TYPES_VIEW = Collections.unmodifiableList(SORTED_TYPES);
    ...
    public static ArmInteractionPointType getPrimaryType(Level level, BlockPos pos, BlockState state) {
        for (ArmInteractionPointType type : SORTED_TYPES_VIEW) {
            if (!type.canCreatePoint(level, pos, state)) continue;
            return type;
        }
        return null;
    }
