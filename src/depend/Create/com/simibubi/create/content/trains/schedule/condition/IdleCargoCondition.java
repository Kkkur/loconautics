...
public class IdleCargoCondition
extends TimedWaitCondition {
    @Override
    public Pair<ItemStack, Component> getSummary() {
        return Pair.of((Object)ItemStack.EMPTY, (Object)CreateLang.translateDirect("schedule.condition.idle_short", this.formatTime(true)));
    }
