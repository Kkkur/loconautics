...
extends ScheduleWaitCondition {
    ...
    public Pair<ItemStack, Component> getSummary() {
        ...
        return Pair.of((Object)AllBlocks.SEATS.get(DyeColor.YELLOW).asStack(), (Object)CreateLang.translateDirect("schedule.condition.player_count." + (target == 1 ? "summary" : "summary_plural"), target));
    }
    ...
    public List<Component> getTitleAs(String type) {
        int target = this.getTarget();
        return ImmutableList.of((Object)CreateLang.translateDirect("schedule.condition.player_count.seated", CreateLang.translateDirect("schedule.condition.player_count." + (target == 1 ? "summary" : "summary_plural"), Component.literal((String)("" + target)).withStyle(ChatFormatting.DARK_AQUA))));
    }
