...
extends ScheduleWaitCondition {
    ...
    public Pair<ItemStack, Component> getSummary() {
        return Pair.of((Object)new ItemStack((ItemLike)Items.STRUCTURE_VOID), (Object)this.getDigitalDisplay(this.intData("Hour"), this.intData("Minute"), false));
    }
    ...
    public boolean renderSpecialIcon(GuiGraphics graphics, int x, int y) {
        ...
        ResourceLocation location = ResourceLocation.withDefaultNamespace((String)("textures/item/clock_" + this.twoDigits(Mth.clamp((int)((int)(progress * 64.0f)), (int)0, (int)63)) + ".png"));
    ...
    public void initConfigurationWidgets(ModularGuiLineBuilder builder) {
        ...
        ((ScrollInput)((Object)hourInput.getValue())).titled(CreateLang.translateDirect("generic.daytime.hour", new Object[0])).calling(t -> {
            this.data.putInt("Hour", t.intValue());
        ...
        ((ScrollInput)((Object)minuteInput.getValue())).titled(CreateLang.translateDirect("generic.daytime.minute", new Object[0])).calling(t -> {
            this.data.putInt("Minute", t.intValue());
    ...
    public MutableComponent getWaitingStatus(Level level, Train train, CompoundTag tag) {
        ...
        return CreateLang.translateDirect("schedule.condition.time_of_day.status", new Object[0]).append((Component)this.getDigitalDisplay(departingHour, departingMinute, false));
    }
}
