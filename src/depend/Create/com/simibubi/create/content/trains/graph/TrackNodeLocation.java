...
extends Vec3i {
    ...
    public CompoundTag write(DimensionPalette dimensions) {
        ...
        c.put("Pos", NbtUtils.writeBlockPos((BlockPos)new BlockPos((Vec3i)this)));
        if (dimensions != null) {
    ...
    public static TrackNodeLocation read(CompoundTag tag, DimensionPalette dimensions) {
        TrackNodeLocation location = TrackNodeLocation.fromPackedPos(tag.contains("Pos") ? NBTHelper.readBlockPos((CompoundTag)tag, (String)"Pos") : new BlockPos(tag.getInt("X"), tag.getInt("Y"), tag.getInt("Z")));
        if (dimensions != null) {
    ...
    public static TrackNodeLocation receive(FriendlyByteBuf buffer, DimensionPalette dimensions) {
        TrackNodeLocation location = TrackNodeLocation.fromPackedPos(new BlockPos(buffer.readVarInt(), (int)buffer.readShort(), buffer.readVarInt()));
