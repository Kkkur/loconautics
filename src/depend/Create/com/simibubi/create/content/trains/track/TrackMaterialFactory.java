...
public class TrackMaterialFactory {
    ...
    public TrackMaterialFactory(ResourceLocation id) {
        this.railsIngredient = Ingredient.fromValues(Stream.of(new Ingredient.TagValue(Tags.Items.NUGGETS_IRON), new Ingredient.TagValue(CommonMetal.ZINC.nuggets)));
    ...
    public TrackMaterialFactory sleeper(ItemLike ... items) {
        this.sleeperIngredient = Ingredient.of((ItemLike[])items);
        return this;
    }
    ...
    public TrackMaterialFactory rails(ItemLike ... items) {
        this.railsIngredient = Ingredient.of((ItemLike[])items);
        return this;
    }
    ...
    public TrackMaterialFactory standardModels() {
        CatnipServices.PLATFORM.executeOnClientOnly(() -> () -> {
            ...
            this.tieModel = PartialModel.of((ResourceLocation)ResourceLocation.fromNamespaceAndPath((String)namespace, (String)(prefix + "tie")));
            this.leftSegmentModel = PartialModel.of((ResourceLocation)ResourceLocation.fromNamespaceAndPath((String)namespace, (String)(prefix + "segment_left")));
            this.rightSegmentModel = PartialModel.of((ResourceLocation)ResourceLocation.fromNamespaceAndPath((String)namespace, (String)(prefix + "segment_right")));
        });
        return this;
    }
    ...
    public TrackMaterialFactory customModels(Supplier<Supplier<PartialModel>> tieModel, Supplier<Supplier<PartialModel>> leftSegmentModel, Supplier<Supplier<PartialModel>> rightSegmentModel) {
        CatnipServices.PLATFORM.executeOnClientOnly(() -> () -> this.lambda$customModels$4((Supplier)tieModel, (Supplier)leftSegmentModel, (Supplier)rightSegmentModel));
        return this;
    }
