...
public class ObservedTrainNameSource
extends SingleLineDisplaySource {
    @Override
    protected MutableComponent provideLine(DisplayLinkContext context, DisplayTargetStats stats) {
        BlockEntity blockEntity = context.getSourceBlockEntity();
        if (!(blockEntity instanceof TrackObserverBlockEntity)) {
            return EMPTY_LINE;
        }
        TrackObserverBlockEntity observerBE = (TrackObserverBlockEntity)blockEntity;
