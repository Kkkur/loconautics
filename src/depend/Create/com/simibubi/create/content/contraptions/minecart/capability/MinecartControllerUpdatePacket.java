...
{
    public static final StreamCodec<ByteBuf, MinecartControllerUpdatePacket> STREAM_CODEC = StreamCodec.composite((StreamCodec)ByteBufCodecs.INT, MinecartControllerUpdatePacket::entityId, (StreamCodec)CatnipStreamCodecBuilders.nullable((StreamCodec)ByteBufCodecs.COMPOUND_TAG), MinecartControllerUpdatePacket::nbt, MinecartControllerUpdatePacket::new);
    ...
    public void handle(LocalPlayer player) {
        ...
        if (entityByID.hasData(AllAttachmentTypes.MINECART_CONTROLLER)) {
            if (this.nbt == null) {
                ...
                controller.deserializeNBT((HolderLookup.Provider)player.registryAccess(), this.nbt);
            }
        }
    }
