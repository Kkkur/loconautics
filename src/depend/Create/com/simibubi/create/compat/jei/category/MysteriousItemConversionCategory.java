...
public class MysteriousItemConversionCategory
extends CreateRecipeCategory<ConversionRecipe> {
    public static final List<RecipeHolder<ConversionRecipe>> RECIPES = new ArrayList<RecipeHolder<ConversionRecipe>>();
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, ConversionRecipe recipe, IFocusGroup focuses) {
        builder.addSlot(RecipeIngredientRole.INPUT, 27, 17).setBackground(MysteriousItemConversionCategory.getRenderedSlot(), -1, -1).addIngredients((Ingredient)recipe.getIngredients().get(0));
        builder.addSlot(RecipeIngredientRole.OUTPUT, 132, 17).setBackground(MysteriousItemConversionCategory.getRenderedSlot(), -1, -1).addItemStack(recipe.getRollableResults().get(0).getStack());
    }
