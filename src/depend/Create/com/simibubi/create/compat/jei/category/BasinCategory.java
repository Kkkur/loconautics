...
extends CreateRecipeCategory<BasinRecipe> {
    ...
    public void draw(BasinRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics graphics, double mouseX, double mouseY) {
        ...
        graphics.drawString(Minecraft.getInstance().font, (Component)CreateLang.translateDirect(requiredHeat.getTranslationKey(), new Object[0]), 9, 86, requiredHeat.getColor(), false);
    }
}
