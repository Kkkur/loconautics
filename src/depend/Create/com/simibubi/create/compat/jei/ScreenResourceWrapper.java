...
implements IDrawable {
    ...
    public void draw(GuiGraphics graphics, int xOffset, int yOffset) {
        graphics.blit(this.resource.location, xOffset, yOffset, 0, (float)this.resource.getStartX(), (float)this.resource.getStartY(), this.resource.getWidth(), this.resource.getHeight(), 256, 256);
    }
}
