...
implements Box {
    ...
    public void nextPowerOf2() {
        int sizeX = Mth.smallestEncompassingPowerOfTwo((int)this.sizeX());
        int sizeY = Mth.smallestEncompassingPowerOfTwo((int)this.sizeY());
        int sizeZ = Mth.smallestEncompassingPowerOfTwo((int)this.sizeZ());
    ...
    public void nextPowerOf2Centered() {
        ...
        int newSizeX = Mth.smallestEncompassingPowerOfTwo((int)sizeX);
        int newSizeY = Mth.smallestEncompassingPowerOfTwo((int)sizeY);
        int newSizeZ = Mth.smallestEncompassingPowerOfTwo((int)sizeZ);
    ...
    public void mirrorAbout(Direction.Axis axis) {
        Vec3i axisVec = Direction.get((Direction.AxisDirection)Direction.AxisDirection.POSITIVE, (Direction.Axis)axis).getNormal();
