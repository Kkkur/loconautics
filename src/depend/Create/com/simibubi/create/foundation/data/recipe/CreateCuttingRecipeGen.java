...
extends CuttingRecipeGen {
    BaseRecipeProvider.GeneratedRecipe ANDESITE_ALLOY = this.create(CreateRecipeProvider.I::andesiteAlloy, b -> (StandardProcessingRecipe.Builder)((StandardProcessingRecipe.Builder)b.duration(200)).output((ItemLike)AllBlocks.SHAFT.get(), 6));
    BaseRecipeProvider.GeneratedRecipe BAMBOO_PLANKS = this.create(() -> Blocks.BAMBOO_PLANKS, b -> (StandardProcessingRecipe.Builder)((StandardProcessingRecipe.Builder)b.duration(20)).output((ItemLike)Blocks.BAMBOO_MOSAIC, 1));
    ...
    BaseRecipeProvider.GeneratedRecipe IE_WIRES = this.ieWires(CommonMetal.COPPER, CommonMetal.ELECTRUM, CommonMetal.ALUMINUM, CommonMetal.STEEL, CommonMetal.LEAD);
    ...
    BaseRecipeProvider.GeneratedRecipe ieWires(CommonMetal ... metals) {
        for (CommonMetal metal : metals) {
            this.create(Mods.IE.recipeId("wire_" + String.valueOf((Object)metal)), b -> (StandardProcessingRecipe.Builder)((StandardProcessingRecipe.Builder)((StandardProcessingRecipe.Builder)((StandardProcessingRecipe.Builder)b.duration(50)).require(metal.plates)).output(1.0f, Mods.IE, "wire_" + String.valueOf((Object)metal), 2)).whenModLoaded(Mods.IE.getId()));
        }
        return null;
    }
}
