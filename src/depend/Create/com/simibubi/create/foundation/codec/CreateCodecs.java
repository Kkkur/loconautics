...
public class CreateCodecs {
    ...
    public static final Codec<ItemStackHandler> ITEM_STACK_HANDLER = Codec.lazyInitialized(() -> ItemSlots.CODEC.xmap(slots -> slots.toHandler(ItemStackHandler::new), ItemSlots::fromHandler));
    ...
    public static Codec<SizedFluidIngredient> FLAT_SIZED_FLUID_INGREDIENT_WITH_TYPE = RecordCodecBuilder.create(instance -> instance.group((App)NeoForgeRegistries.FLUID_INGREDIENT_TYPES.byNameCodec().fieldOf("type").forGetter(i -> i.ingredient().getType()), (App)FluidIngredient.MAP_CODEC_NONEMPTY.forGetter(SizedFluidIngredient::ingredient), (App)NeoForgeExtraCodecs.optionalFieldAlwaysWrite((Codec)ExtraCodecs.POSITIVE_INT, (String)"amount", (Object)1000).forGetter(SizedFluidIngredient::amount)).apply((Applicative)instance, (type, ingredient, amount) -> new SizedFluidIngredient(ingredient, amount.intValue())));
