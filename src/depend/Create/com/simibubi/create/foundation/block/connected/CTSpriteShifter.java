...
public class CTSpriteShifter {
    private static final Map<String, CTSpriteShiftEntry> ENTRY_CACHE = new HashMap<String, CTSpriteShiftEntry>();

    public static CTSpriteShiftEntry getCT(CTType type, ResourceLocation blockTexture, ResourceLocation connectedTexture) {
        String key = String.valueOf(blockTexture) + "->" + String.valueOf(connectedTexture) + "+" + String.valueOf(type.getId());
