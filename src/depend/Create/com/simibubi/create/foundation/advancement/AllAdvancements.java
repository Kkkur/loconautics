...
implements DataProvider {
    ...
    public static final CreateAdvancement COMPACTING = AllAdvancements.create("compacting", b -> b.icon((ItemLike)Blocks.IRON_BLOCK).title("Compactification").description("Use a Mechanical Press and a Basin to create fewer items from more").after(SAW_PROCESSING));
    ...
    public static final CreateAdvancement ANVIL_PLOUGH = AllAdvancements.create("anvil_plough", b -> b.icon((ItemLike)Blocks.CHIPPED_ANVIL).title("Blacksmith Artillery").description("Launch an Anvil with Mechanical Ploughs").after(CART_PICKUP).special(CreateAdvancement.TaskType.EXPERT));
    ...
    public static final CreateAdvancement CARDBOARD = AllAdvancements.create("cardboard", b -> b.icon((ItemProviderEntry<?, ?>)AllItems.CARDBOARD).title("Part and Parcel").description("Produce or obtain your first Cardboard").whenIconCollected().after(MIXER));
    public static final CreateAdvancement PACKAGER = AllAdvancements.create("packager", b -> b.icon((ItemProviderEntry<?, ?>)AllBlocks.PACKAGER).title("Post Production").description("Package items from an inventory using the Packager").after(CARDBOARD));
    public static final CreateAdvancement STOCK_TICKER = AllAdvancements.create("stock_ticker", b -> b.icon((ItemProviderEntry<?, ?>)AllBlocks.STOCK_TICKER).title("Order Up!").description("Employ a mob at your stock ticker and make your first requests").special(CreateAdvancement.TaskType.NOISY).after(PACKAGER));
    public static final CreateAdvancement FROGPORT = AllAdvancements.create("frogport", b -> b.icon((ItemProviderEntry<?, ?>)AllBlocks.PACKAGE_FROGPORT).title("Hungry hoppers").description("Catch packages from your Chain Conveyor using a Frogport").special(CreateAdvancement.TaskType.NOISY).after(STOCK_TICKER));
    public static final CreateAdvancement TABLE_CLOTH_SHOP = AllAdvancements.create("table_cloth_shop", b -> b.icon((ItemProviderEntry<?, ?>)AllBlocks.TABLE_CLOTHS.get(DyeColor.RED)).title("Open for business").description("Put items up for sale using a Table Cloth").special(CreateAdvancement.TaskType.NOISY).after(FROGPORT));
    public static final CreateAdvancement FACTORY_GAUGE = AllAdvancements.create("factory_gauge", b -> b.icon((ItemProviderEntry<?, ?>)AllBlocks.FACTORY_GAUGE).title("High Logistics").description("Trigger an automatic package request using Factory Gauges").special(CreateAdvancement.TaskType.NOISY).after(TABLE_CLOTH_SHOP));
    public static final CreateAdvancement CARDBOARD_ARMOR = AllAdvancements.create("cardboard_armor", b -> b.icon((ItemProviderEntry<?, ?>)AllItems.CARDBOARD_CHESTPLATE).title("Full Stealth").description("Sneak around in full Cardboard Armor").after(FACTORY_GAUGE));
    public static final CreateAdvancement PACKAGE_CHUTE_THROW = AllAdvancements.create("package_chute_throw", b -> b.icon(PackageStyles.getDefaultBox()).title("Nothing but net").description("Land your cardboard package throw in an item chute").after(CARDBOARD_ARMOR).special(CreateAdvancement.TaskType.SECRET));
    public static final CreateAdvancement CARDBOARD_ARMOR_TRIM = AllAdvancements.create("cardboard_armor_trim", b -> b.icon(AllAdvancements::createArmorTrimmedCardboardChestplate).title("Arts and Crafts").description("Decorate your cardboard equipment with armor trims").after(CARDBOARD_ARMOR).special(CreateAdvancement.TaskType.SECRET));
    public static final CreateAdvancement COPPER = AllAdvancements.create("copper", b -> b.icon((ItemLike)Items.COPPER_INGOT).title("Cuprum Bokum").description("Amass some Copper Ingots for your exploits in fluid manipulation").whenIconCollected().after(BLAZE_BURNER).special(CreateAdvancement.TaskType.SILENT));
    public static final CreateAdvancement COPPER_CASING = AllAdvancements.create("copper_casing", b -> b.icon((ItemProviderEntry<?, ?>)AllBlocks.COPPER_CASING).title("The Copper Age").description("Apply Copper Ingots to stripped wood, creating a waterproof casing for your machines").after(COPPER));
    ...
    public static final CreateAdvancement WATER_SUPPLY = AllAdvancements.create("water_supply", b -> b.icon((ItemLike)Items.WATER_BUCKET).title("Puddle Collector").description("Use the pulling end of a Fluid Pipe or Mechanical Pump to collect water").after(GLASS_PIPE));
    ...
    public static final CreateAdvancement CHOCOLATE_BUCKET = AllAdvancements.create("chocolate_bucket", b -> b.icon((ItemLike)((BaseFlowingFluid.Flowing)AllFluids.CHOCOLATE.get()).getBucket()).title("A World of Imagination").description("Obtain a bucket of molten chocolate").whenIconCollected().after(HOSE_PULLEY));
    public static final CreateAdvancement HONEY_DRAIN = AllAdvancements.create("honey_drain", b -> b.icon((ItemLike)Items.BEEHIVE).title("Autonomous Bee-Keeping").description("Use pipes to pull honey from a Bee Nest or Beehive").after(CHOCOLATE_BUCKET));
    ...
    public static final CreateAdvancement CROSS_STREAMS = AllAdvancements.create("cross_streams", b -> b.icon((ItemLike)Blocks.COBBLESTONE).title("Don't Cross the Streams!").description("Watch two fluids meet in your pipe network").after(BACKTANK).special(CreateAdvancement.TaskType.SECRET));
    ...
    public static final CreateAdvancement ROSE_QUARTZ = AllAdvancements.create("rose_quartz", b -> b.icon((ItemProviderEntry<?, ?>)AllItems.POLISHED_ROSE_QUARTZ).title("Supercharged").description("Polish some Rose Quartz").whenIconCollected().after(BRASS_CASING));
    ...
    public static final CreateAdvancement CRUSHING_WHEEL = AllAdvancements.create("crushing_wheel", b -> b.icon((ItemProviderEntry<?, ?>)AllBlocks.CRUSHING_WHEEL).title("Wheels of Destruction").description("Place and power a set of Crushing Wheels").after(CRAFTER).special(CreateAdvancement.TaskType.NOISY));
    ...
    public static final CreateAdvancement DISPLAY_LINK = AllAdvancements.create("display_link", b -> b.icon((ItemProviderEntry<?, ?>)AllBlocks.DISPLAY_LINK).title("Big Data").description("Use a Display Link to visualise information").after(CLOCKWORK_BEARING));
    ...
    public static final CreateAdvancement POTATO_CANNON_COLLIDE = AllAdvancements.create("potato_cannon_collide", b -> b.icon((ItemLike)Items.CARROT).title("Veggie Fireworks").description("Cause Potato Cannon projectiles of different types to collide with each other").after(ARM_MANY_TARGETS).special(CreateAdvancement.TaskType.EXPERT));
    public static final CreateAdvancement SELF_DEPLOYING = AllAdvancements.create("self_deploying", b -> b.icon((ItemLike)Items.RAIL).title("Self-Driving Cart").description("Create a Minecart Contraption that places tracks in front of itself").after(POTATO_CANNON_COLLIDE).special(CreateAdvancement.TaskType.EXPERT));
    ...
    public static final CreateAdvancement MUSICAL_ARM = AllAdvancements.create("musical_arm", b -> b.icon((ItemLike)Blocks.JUKEBOX).title("DJ Mechanico").description("Watch a Mechanical Arm operate your Jukebox").after(CRAFTER).special(CreateAdvancement.TaskType.SECRET));
    ...
    public static final CreateAdvancement TRAIN_CASING = AllAdvancements.create("train_casing_00", b -> b.icon((ItemProviderEntry<?, ?>)AllBlocks.RAILWAY_CASING).title("The Locomotive Age").description("Use Sturdy Sheets to create a casing for railway components").after(STURDY_SHEET));
    ...
    public static final CreateAdvancement TRAIN_TRACK = AllAdvancements.create("track_0", b -> b.icon((ItemProviderEntry<?, ?>)AllBlocks.TRACK).title("A New Gauge").description("Obtain some Train Tracks").whenItemCollected(AllTags.AllItemTags.TRACKS.tag).after(STURDY_SHEET));
    ...
    public static final CreateAdvancement TRAIN_PORTAL = AllAdvancements.create("train_portal", b -> b.icon((ItemLike)Blocks.AMETHYST_BLOCK).title("Dimensional Commuter").description("Ride a Train through a portal").after(TRAIN_WHISTLE).special(CreateAdvancement.TaskType.NOISY));
    ...
    public static final CreateAdvancement LONG_TRAIN = AllAdvancements.create("long_train", b -> b.icon((ItemLike)Items.MINECART).title("Ambitious Endeavours").description("Create a Train with at least 6 carriages").after(TRACK_CRAFTING).special(CreateAdvancement.TaskType.EXPERT));
    ...
    public static final CreateAdvancement TRAIN_ROADKILL = AllAdvancements.create("train_roadkill", b -> b.icon((ItemLike)Items.DIAMOND_SWORD).title("Road Kill").description("Run over an enemy with your Train").after(SIGNAL).special(CreateAdvancement.TaskType.SECRET));
    ...
    private static ItemStack createArmorTrimmedCardboardChestplate(HolderLookup.Provider registries) {
        HolderLookup.RegistryLookup materialLookup = registries.lookupOrThrow(Registries.TRIM_MATERIAL);
        HolderLookup.RegistryLookup patternLookup = registries.lookupOrThrow(Registries.TRIM_PATTERN);
        ArmorTrim trim = new ArmorTrim((Holder)materialLookup.getOrThrow(TrimMaterials.DIAMOND), (Holder)patternLookup.getOrThrow(TrimPatterns.SENTRY));
        ItemStack asStack = AllItems.CARDBOARD_CHESTPLATE.asStack();
        asStack.set(DataComponents.TRIM, (Object)trim);
        return asStack;
    }
