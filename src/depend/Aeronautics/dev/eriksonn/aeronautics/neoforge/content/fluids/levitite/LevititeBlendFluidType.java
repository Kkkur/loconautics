...
public class LevititeBlendFluidType
extends AeroFluidType {
    public LevititeBlendFluidType(FluidType.Properties properties, ResourceLocation stillTexture, ResourceLocation flowingTexture) {
    ...
    public boolean move(FluidState state, LivingEntity entity, Vec3 movementVector, double gravity) {
        ...
        if (fluidHeight <= entity.getFluidJumpThreshold()) {
            entity.setDeltaMovement(entity.getDeltaMovement().multiply(0.5, (double)0.7f, 0.5));
        ...
        if (entity.horizontalCollision && entity.isFree(interV.x, interV.y + (double)0.6f - entity.getY() + originalY, interV.z)) {
            entity.setDeltaMovement(interV.x, (double)0.3f, interV.z);
        }
        return true;
    }
}
