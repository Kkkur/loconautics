...
public class AeroEntityTypes {
    ...
    public static final EntityEntry<PropellerBearingContraptionEntity> PROPELLER_CONTROLLED_CONTRAPTION = ((EntityBuilder)REGISTRATE.entity("propeller_bearing_contraption", PropellerBearingContraptionEntity::new, MobCategory.MISC).visual(() -> ContraptionVisual::new).renderer(() -> ContraptionEntityRenderer::new).transform(builder -> builder.properties(b -> b.clientTrackingRange(20).updateInterval(40).sized(1.0f, 1.0f).eyeHeight(0.0f).fireImmune()))).register();
    public static final EntityEntry<GustEntity> GUST = ((EntityBuilder)REGISTRATE.entity("gust", GustEntity::new, MobCategory.MISC).renderer(() -> NoopRenderer::new).transform(builder -> builder.properties(b -> b.clientTrackingRange(20).sized(1.0f, 1.0f).eyeHeight(0.0f).fireImmune()))).register();
