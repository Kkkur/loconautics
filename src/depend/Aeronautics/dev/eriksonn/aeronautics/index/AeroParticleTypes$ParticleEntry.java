...
public static class AeroParticleTypes.ParticleEntry<D extends ParticleOptions> {
    private final Supplier<? extends ICustomParticleData<D>> typeFactory;
    private final ParticleType<D> object;

    public AeroParticleTypes.ParticleEntry(Supplier<? extends ICustomParticleData<D>> typeFactory) {
