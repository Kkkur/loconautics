 ...
 *  dev.ryanhcode.sable.mixinterface.particle.ParticleExtension
...
implements ParticleSubLevelKickable {
    ...
    public void render(VertexConsumer buffer, Camera renderInfo, float partialTicks) {
        this.renderOrientation.set((Quaternionfc)this.orientation);
        ...
        if (subLevel instanceof ClientSubLevel) {
            ClientSubLevel subLevel2 = (ClientSubLevel)subLevel;
            Quaterniondc orientation1 = subLevel2.renderPose().orientation();
            this.renderOrientation.premul((Quaternionfc)this.subLevelOrientation.set(orientation1));
        }
