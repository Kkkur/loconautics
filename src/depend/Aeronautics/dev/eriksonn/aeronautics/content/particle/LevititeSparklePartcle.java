...
public class LevititeSparklePartcle
extends SimpleAnimatedParticle {
    protected LevititeSparklePartcle(ClientLevel level, double x, double y, double z, double dx, double dy, double dz, SpriteSet sprite, int color) {
