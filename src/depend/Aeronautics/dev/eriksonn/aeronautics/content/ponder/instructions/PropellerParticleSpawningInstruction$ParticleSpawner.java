...
public static class PropellerParticleSpawningInstruction.ParticleSpawner {
    ...
    PropellerParticleSpawningInstruction.ParticleSpawner(@Nullable ElementLink<WorldSectionElement> link, BlockPos location, Direction direction, float particleAmount, float particleSpeed, float radius, boolean hasCollision) {
        this.link = link;
