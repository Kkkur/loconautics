...
public class DefaultLiftingGas
implements LiftingGasType {
    @Override
    public Component getName() {
        return AeroLang.translate("lifting_gas.default", new Object[0]).component();
    }
    ...
    public double getLiftStrength() {
        return (Double)AeroConfig.server().physics.hotAirStrength.get();
    }
