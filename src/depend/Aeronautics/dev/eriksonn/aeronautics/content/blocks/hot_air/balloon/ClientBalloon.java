...
extends Balloon {
    ...
    @ApiStatus.Internal
    public ClientBalloon(Level level, LevelAccelerator accelerator, BlockPos controllerPos, BalloonLayerGraph graph, ObjectArrayList<BlockEntityLiftingGasProvider> heaters) {
