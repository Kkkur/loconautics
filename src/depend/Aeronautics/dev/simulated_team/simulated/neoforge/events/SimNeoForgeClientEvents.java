...
@EventBusSubscriber(modid="simulated", value={Dist.CLIENT})
public class SimNeoForgeClientEvents {
    ...
    @SubscribeEvent
    public static void postMouseButtonInput(InputEvent.MouseButton.Post event) {
    ...
    public static void playerInteractRightClickBlock(PlayerInteractEvent.RightClickBlock event) {
        ...
        if (event.getEntity().isLocalPlayer() && (res = SimulatedCommonClientEvents.onRightClickBlock(event.getEntity(), event.getHand(), event.getPos(), event.getHitVec())) != null) {
