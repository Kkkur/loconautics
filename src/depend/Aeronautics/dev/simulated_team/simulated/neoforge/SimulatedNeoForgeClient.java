...
@Mod(value="simulated", dist={Dist.CLIENT})
public class SimulatedNeoForgeClient {
    public SimulatedNeoForgeClient(IEventBus modEventBus, ModContainer container) {
        container.registerExtensionPoint(IConfigScreenFactory.class, (IExtensionPoint)((IConfigScreenFactory)(c, l) -> new BaseConfigScreen(l, "simulated")));
