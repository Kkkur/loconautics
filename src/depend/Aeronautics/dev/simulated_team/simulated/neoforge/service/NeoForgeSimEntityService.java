...
public class NeoForgeSimEntityService
implements SimEntityService {
    @Override
    public CompoundTag getCustomData(Entity player) {
    ...
    @Override
    public <T extends Entity, P> EntityBuilder<T, P> loaderEntityTransform(EntityBuilder<T, P> builder, SimEntityTypes.EntityLoaderData data) {
