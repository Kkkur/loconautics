...
public class SimPacketManager {
    public static final VeilPacketManager INSTANCE = VeilPacketManager.create((String)"simulated", (String)"0.1");
    ...
    public static void init() {
        ...
        INSTANCE.registerServerbound(ConfigureAltitudeSensorPacket.TYPE, ConfigureAltitudeSensorPacket.CODEC, SimBlockEntityConfigurationPacket::handle);
        INSTANCE.registerServerbound(ConfigureModulatingLinkedRecieverPacket.TYPE, ConfigureModulatingLinkedRecieverPacket.CODEC, SimBlockEntityConfigurationPacket::handle);
