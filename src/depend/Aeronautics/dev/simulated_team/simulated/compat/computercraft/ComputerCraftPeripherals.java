...
import dev.simulated_team.simulated.compat.computercraft.peripherals.AltitudeSensorPeripheral;
...
import dev.simulated_team.simulated.compat.computercraft.peripherals.NavTablePeripheral;
import dev.simulated_team.simulated.compat.computercraft.peripherals.OpticalSensorPeripheral;
import dev.simulated_team.simulated.compat.computercraft.peripherals.SwivelBearingPeripheral;
import dev.simulated_team.simulated.compat.computercraft.peripherals.TorsionSpringPeripheral;
import dev.simulated_team.simulated.compat.computercraft.peripherals.VelocitySensorPeripheral;
...
public class ComputerCraftPeripherals
implements SimModCompatibilityService {
    ...
    public void init() {
        ...
        service.addWired(SimBlockEntityTypes.DOCKING_CONNECTOR, (blockEntity, direction) -> {
            if (blockEntity.getBlockState().getValue((Property)DockingConnectorBlock.FACING) == direction) {
                return null;
            }
