...
public class VelocitySensorShaper
extends VoxelShaper {
    ...
    static VelocitySensorShaper make() {
        ...
        shaper.axisFalse = VelocitySensorShaper.forDirectional((VoxelShape)SimBlockShapes.VELOCITY_SENSOR, (Direction)Direction.UP);
        shaper.axisTrue = VelocitySensorShaper.forDirectional((VoxelShape)VelocitySensorShaper.rotatedCopy((VoxelShape)SimBlockShapes.VELOCITY_SENSOR, (Vec3)new Vec3(0.0, 90.0, 0.0)), (Direction)Direction.UP);
