...
public static class TorsionSpringBlockEntity.TorsionSpringScrollValueBehaviour
extends ScrollValueBehaviour {
    public TorsionSpringBlockEntity.TorsionSpringScrollValueBehaviour(SmartBlockEntity be) {
        super((Component)SimLang.translate("torsion_spring.angle_limit", new Object[0]).component(), be, (ValueBoxTransform)new TorsionSpringBlockEntity.TorsionSpringValueBox());
