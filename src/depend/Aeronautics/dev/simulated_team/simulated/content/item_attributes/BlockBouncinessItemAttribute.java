...
{
    public static final MapCodec<BlockBouncinessItemAttribute> CODEC = Codec.DOUBLE.xmap(BlockBouncinessItemAttribute::new, BlockBouncinessItemAttribute::bounciness).fieldOf("value");
    public static final StreamCodec<ByteBuf, BlockBouncinessItemAttribute> STREAM_CODEC = ByteBufCodecs.DOUBLE.map(BlockBouncinessItemAttribute::new, BlockBouncinessItemAttribute::bounciness);
    ...
    public boolean appliesTo(ItemStack stack, Level world) {
        ...
        if (item instanceof BlockItem) {
            ...
            return ((Double)extension.sable$getProperty((PhysicsBlockPropertyTypes.PhysicsBlockPropertyType)PhysicsBlockPropertyTypes.FRICTION.get())).doubleValue() == this.bounciness();
        }
        return false;
    }
    ...
    implements ItemAttributeType {
        ...
        public List<ItemAttribute> getAllAttributes(ItemStack stack, Level level) {
            ...
            if (item instanceof BlockItem) {
                BlockItem item2 = (BlockItem)item;
                BlockStateExtension extension = (BlockStateExtension)item2.getBlock().defaultBlockState();
                double mass = (Double)extension.sable$getProperty((PhysicsBlockPropertyTypes.PhysicsBlockPropertyType)PhysicsBlockPropertyTypes.RESTITUTION.get());
