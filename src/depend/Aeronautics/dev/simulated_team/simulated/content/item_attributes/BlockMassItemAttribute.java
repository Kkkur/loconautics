...
public record BlockMassItemAttribute(double mass) implements ItemAttribute
{
    ...
    public static final StreamCodec<ByteBuf, BlockMassItemAttribute> STREAM_CODEC = ByteBufCodecs.DOUBLE.map(BlockMassItemAttribute::new, BlockMassItemAttribute::mass);
    ...
    public boolean appliesTo(ItemStack stack, Level world) {
        ...
        if (item instanceof BlockItem) {
            ...
            return ((Double)extension.sable$getProperty((PhysicsBlockPropertyTypes.PhysicsBlockPropertyType)PhysicsBlockPropertyTypes.MASS.get())).doubleValue() == this.mass();
        }
        return false;
    }
