...
extends ConfigBase {
    public final SimKinetics kinetics = (SimKinetics)this.nested(0, SimKinetics::new, new String[]{Comments.kinetics});
    public final SimAssembly assembly = (SimAssembly)this.nested(0, SimAssembly::new, new String[]{Comments.assembly});
    public final SimPhysics physics = (SimPhysics)this.nested(0, SimPhysics::new, new String[]{Comments.physics});
    public final SimBlockConfigs blocks = (SimBlockConfigs)this.nested(0, SimBlockConfigs::new, new String[]{Comments.blockConfig});
    public final SimEquipment equipment = (SimEquipment)this.nested(0, SimEquipment::new, new String[]{Comments.equipmentConfig});
