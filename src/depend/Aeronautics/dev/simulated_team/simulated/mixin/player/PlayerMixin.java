...
implements PlayerTypewriterExtension,
PlayerLaunchedPlungerExtension {
    @Unique
    ...
    @Override
    public void simulated$setCurrentTypewriter(BlockPos pos) {
        this.simulated$currentTypeWriter = pos;
    }

    @Override
    public void simulated$setLaunchedPlunger(LaunchedPlungerEntity plunger) {
