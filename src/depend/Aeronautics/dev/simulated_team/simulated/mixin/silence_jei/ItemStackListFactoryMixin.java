 ...
 *  mezz.jei.library.plugins.vanilla.ingredients.ItemStackListFactory
...
@Pseudo
@Mixin(value={ItemStackListFactory.class})
public class ItemStackListFactoryMixin {
    ...
    private static void simulated$error(Logger instance, String string, Object o, Object o1, Object o2, Operation<Void> original, @Local(argsOnly=true) CreativeModeTab tab) {
        if (tab != SimTabService.INSTANCE.getCreativeTab()) {
