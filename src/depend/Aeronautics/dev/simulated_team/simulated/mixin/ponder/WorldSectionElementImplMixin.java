...
public class WorldSectionElementImplMixin {
    ...
    public Rotate<PoseTransformStack> fixRotateY(PoseTransformStack instance, float v, Operation<Rotate<PoseTransformStack>> original, @Local(ordinal=1) double rotZ) {
    ...
    public Rotate<PoseTransformStack> fixRotateZ(PoseTransformStack instance, float v, Operation<Rotate<PoseTransformStack>> original, @Local(ordinal=2) double rotY) {
    ...
    public Rotate<PoseTransformStack> fixUnRotateY(PoseTransformStack instance, float v, Operation<Rotate<PoseTransformStack>> original, @Local(ordinal=1) double rotZ) {
        return instance.rotateZDegrees((float)(-rotZ));
    }
    ...
    public Rotate<PoseTransformStack> fixUnRotateZ(PoseTransformStack instance, float v, Operation<Rotate<PoseTransformStack>> original, @Local(ordinal=2) double rotY) {
        return instance.rotateYDegrees((float)(-rotY));
    }
}
