...
public class OffsetBreakParticlesInstruction
        ...
        for (int l = 0; l < i; ++l) {
            for (int i1 = 0; i1 < j; ++i1) {
                for (int j1 = 0; j1 < k; ++j1) {
                    ...
                    level.addParticle((ParticleOptions)new BlockParticleOption(ParticleTypes.BLOCK, state), posX, posY, posZ, subPosX - 0.5, subPosY - 0.5, subPosZ - 0.5);
                }
            }
        }
    }
