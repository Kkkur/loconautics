...
public static class AltitudeSensorVisualHeightInstruction.Radial
extends AltitudeSensorVisualHeightInstruction {
    public AltitudeSensorVisualHeightInstruction.Radial(BlockPos location, int ticks, float startValue, float endValue, FloatUnaryOperator interpolation) {
