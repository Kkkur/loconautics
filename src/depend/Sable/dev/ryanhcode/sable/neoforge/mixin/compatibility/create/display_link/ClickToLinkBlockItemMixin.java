...
@Mixin(value={ClickToLinkBlockItem.class})
public class ClickToLinkBlockItemMixin {
    ...
    public boolean sable$accountForSubLevels(BlockPos instance, Vec3i pos, double v, Operation<Boolean> original, @Local Level level) {
        return Sable.HELPER.distanceSquaredWithSubLevels(level, (double)instance.getX() + 0.5, (double)instance.getY() + 0.5, (double)instance.getZ() + 0.5, (double)pos.getX() + 0.5, (double)pos.getY() + 0.5, (double)pos.getZ() + 0.5) < v * v;
    }
}
