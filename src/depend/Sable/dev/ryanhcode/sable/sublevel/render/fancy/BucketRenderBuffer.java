...
public class BucketRenderBuffer
implements NativeResource {
    ...
    public BucketRenderBuffer(StagingBuffer stagingBuffer) {
        ...
        RenderSystem.glBindBuffer((int)34962, (int)this.buffer);
        GL15C.glBufferData((int)34962, (long)8000L, (int)35040);
        this.maxSize = 1000;
    ...
    private void resize(int newSize) {
        ...
        RenderSystem.glBindBuffer((int)36662, (int)this.buffer);
        RenderSystem.glBindBuffer((int)36663, (int)copyDest);
        GL15C.glBufferData((int)36663, (long)((long)newSize * 8L), (int)35040);
        ARBCopyBuffer.glCopyBufferSubData((int)36662, (int)36663, (long)0L, (long)0L, (long)((long)this.maxSize * 8L));
        RenderSystem.glDeleteBuffers((int)this.buffer);
    ...
    public Slice allocate(int quadCount) {
        int toIndex;
        ...
        while (true) {
            if ((toIndex = this.closedBuckets.nextSetBit(fromIndex)) == -1) {
                toIndex = fromIndex + quadCount - 1;
                break;
            }
            if (toIndex - fromIndex >= quadCount) break;
