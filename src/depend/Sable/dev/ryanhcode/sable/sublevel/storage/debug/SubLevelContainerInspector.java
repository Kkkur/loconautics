...
extends SingleWindowInspector {
    public static final Component TITLE = Component.translatable((String)"inspector.sable.sub_level_container.title");
    ...
    protected void renderComponents() {
        ...
        if (clientLevel != null) {
            ...
            ImGui.textDisabled((String)"No level loaded");
        }
    }
    ...
    private void renderPlotContainer(String name, SubLevelContainer plotContainer) {
        ...
        ImGui.button((String)name, (float)sizePixels, (float)sizePixels);
        ...
        if (selectedSubLevel != null) {
            ...
            ImGui.setTooltip((String)String.format("Loaded SubLevel\nChunks: %d", chunkCount));
        }
        if (hovered) {
