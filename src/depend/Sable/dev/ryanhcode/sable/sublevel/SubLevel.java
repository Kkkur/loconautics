...
implements SubLevelAccess {
    ...
    protected SubLevel(Level level, int plotX, int plotY, Pose3d pose) {
        ...
        this.pose = new Pose3d((Pose3dc)pose);
        this.lastPose = new Pose3d((Pose3dc)pose);
    }
    ...
    public void updateLastPose() {
        this.lastPose.set((Pose3dc)this.pose);
    }
    ...
    public void updateBoundingBox() {
        ...
        this.globalBounds.set((double)plotBounds.minX(), (double)plotBounds.minY(), (double)plotBounds.minZ(), (double)plotBounds.maxX() + 1.0, (double)plotBounds.maxY() + 1.0, (double)plotBounds.maxZ() + 1.0);
        this.globalBounds.transform((Pose3dc)this.pose, this.globalBoundsTransform, this.globalBounds);
    }
