...
import dev.ryanhcode.sable.mixinhelpers.voxel_shape_iteration.LongArrayDiscreteVoxelShape;
...
@ApiStatus.Internal
public class FastVoxelShapeIterator
implements Iterator<BoundingBox3dc> {
    ...
    public FastVoxelShapeIterator(DiscreteVoxelShape shape, double[] xValues, double[] yValues, double[] zValues) {
        ...
        this.shape = new LongArrayDiscreteVoxelShape((DiscreteVoxelShape)sourceShape, this.xSize, this.ySize, this.zSize);
            ...
            while (this.x < this.xSize) {
                while (this.z <= this.zSize) {
                    if (this.shape.isFullWide(this.x, this.y, this.z)) {
                        ...
                        this.boundingBox.set(this.xValues[this.x], this.yValues[this.y], this.zValues[this.k], this.xValues[m + 1], this.yValues[n + 1], this.zValues[this.z]);
                        this.hasNext = true;
                        this.k = -1;
                        return;
                    }
