...
public class RigidBodyHandle {
    ...
    public void applyImpulseAtPoint(Vec3 position, Vec3 force) {
        this.physicsSystem.getPipeline().applyImpulse(this.body, (Vector3dc)JOMLConversion.toJOML((Position)position), (Vector3dc)JOMLConversion.toJOML((Position)force));
    }
