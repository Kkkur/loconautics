...
public class SableUDPChannelHandlerClient
extends SimpleChannelInboundHandler<AddressedSableUDPPacket> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, AddressedSableUDPPacket msg) throws Exception {
        ...
        SableClient.NETWORK_EVENT_LOOP.tell(() -> msg.packet().handleClient((Level)client.level));
    }
}
