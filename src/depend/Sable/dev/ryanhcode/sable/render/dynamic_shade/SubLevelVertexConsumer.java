...
public class SubLevelVertexConsumer
implements VertexConsumer {
    ...
    public void putBulkData(PoseStack.Pose pose, BakedQuad bakedQuad, float[] fs, float f, float g, float h, float i, int[] is, int j, boolean bl) {
