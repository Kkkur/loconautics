 ...
 *  snownee.jade.overlay.RayTracing
 */
...
public class RayTracingMixin {
    ...
    private static Optional<Vec3> sable$clip(AABB aabb, Vec3 start, Vec3 end, Operation<Optional<Vec3>> original, @Local(argsOnly=true) Level worldIn) {
        ClientSubLevel subLevel = (ClientSubLevel)Sable.HELPER.getContaining(worldIn, (Position)aabb.getCenter());
        if (subLevel != null) {
        ...
        return (Optional)original.call(new Object[]{aabb, start, end});
    }
