...
public class ClientPacketListenerMixin {
    ...
    private void sable$queueLightData(ClientLevel instance, Runnable task, Operation<Void> original, @Local(argsOnly=true) ClientboundLevelChunkWithLightPacket packet) {
