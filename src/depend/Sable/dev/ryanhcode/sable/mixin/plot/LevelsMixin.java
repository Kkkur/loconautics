...
public abstract class LevelsMixin
extends Level
implements SubLevelContainerHolder {
    @Unique
    private final SubLevelContainer sable$plotContainer = this.sable$createPlotContainer();

    protected LevelsMixin(WritableLevelData writableLevelData, ResourceKey<Level> resourceKey, RegistryAccess registryAccess, Holder<DimensionType> holder, Supplier<ProfilerFiller> supplier, boolean bl, boolean bl2, long l, int i) {
    ...
    private SubLevelContainer sable$createPlotContainer() {
        ...
        SubLevelContainer container = !this.isClientSide ? new ServerSubLevelContainer(this, SubLevelContainer.DEFAULT_LOG_SIZE_LENGTH, SubLevelContainer.DEFAULT_LOG_PLOT_SIZE, 10000, 10000) : new ClientSubLevelContainer(this, SubLevelContainer.DEFAULT_LOG_SIZE_LENGTH, SubLevelContainer.DEFAULT_LOG_PLOT_SIZE, 10000, 10000);
