...
public class SableBufferUtils {
    public static final StreamCodec<? super RegistryFriendlyByteBuf, Pose3d> POSE3D_STREAM_CODEC = StreamCodec.of(SableBufferUtils::write, buf -> SableBufferUtils.read((ByteBuf)buf, new Pose3d()));
